...
INSERT INTO work_define(define_id,work_name,type,enabled,version,process) VALUES
    ...
    ("func.corp.record.delete","删除从业机构备案","data",true,0,false),
    ...
    ("func.corp.record.employee.add", "添加从业人员","data",true,0,false),
    ("func.corp.record.employee.del","删除从业人员","data",true,0,false),
