...
//
  ...
  UNACCEPTED(false, true, false, true, true), //未接受
  ...
  IMMINENT(false, true, true, false, false), //业务即将完成， 已生成部分数据， 目录用于打证
...
//  static final EnumSet<WorkStatus> change = EnumSet.of(VALID,COMPLETED,REJECT,ABORT,DELETED);
  ...
  WorkStatus(boolean valid, boolean processing, boolean fixed, boolean running, boolean failed) {
    this.valid = valid;
