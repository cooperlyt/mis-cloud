...
elif [[ "@project.version@" == *"snapshot" ]] || [[ "@project.version@" == *"SNAPSHOT" ]]; then
  echo "snapshot build"
  docker buildx build . --platform linux/amd64,linux/arm64 --push -t dgsspfdjw.org.cn:8443/@project.name@:snapshot
else
